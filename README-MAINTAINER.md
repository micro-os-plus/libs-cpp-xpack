...
```sh
rm -rf ~/Work/micro-os-plus/libs-cpp-xpack.git && \
mkdir -p ~/Work/micro-os-plus && \
git clone \
  https://github.com/micro-os-plus/libs-cpp-xpack.git \
  ~/Work/micro-os-plus/libs-cpp-xpack.git
```
...
In the `micro-os-plus/libs-cpp-xpack` Git repo:
...
- <https://github.com/micro-os-plus/libs-cpp-xpack/issues/>
...
```sh
xpm run install-all -C ~/Work/micro-os-plus/libs-cpp-xpack.git
xpm run test-all -C ~/Work/micro-os-plus/libs-cpp-xpack.git
```
