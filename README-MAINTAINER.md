...
- name the file like `2020-12-19-libs-cpp-v0-1-0-released.md`
- name the post like: **µOS++ libs-cpp v1.0.4 released**
...
- `npm dist-tag add @micro-os-plus/libs-cpp@1.0.4 latest`
- `npm dist-tag ls @@micro-os-plus/libs-cpp`
...
- paste the release name like **µOS++ libs-cpp v1.0.4 released**
